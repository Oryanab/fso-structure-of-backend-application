...
describe("Largest Post liked", () => {
  ...
  test("return the author who has the largest amount of blogs and number of blogs", () => {
    const result = listHelper.mostBlogs(listWithOneBlog);
    expect(result).toStrictEqual({ author: "Robert C. Martin", blogs: 3 });
  });

  test("return blog posts have the largest amount of likes and its author", () => {
